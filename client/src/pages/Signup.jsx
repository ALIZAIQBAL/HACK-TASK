    ...
    return (
        <div className="flex flex-col md:flex-row h-screen w-screen bg-white">
            ...
            <motion.div
                ...
                className="hidden md:flex flex-col justify-center items-center w-1/2 bg-blue-100 text-blue-800 p-8"
            >
                <h2 className="text-5xl font-bold mb-4">Welcome Aboard!</h2>
                <p className="text-lg">Let’s create something amazing 💫</p>
            </motion.div>
            ...
            >
                <h2 className="text-4xl font-bold text-blue-800 mb-6 text-center">Create Account 🚀</h2>
                <Formik
